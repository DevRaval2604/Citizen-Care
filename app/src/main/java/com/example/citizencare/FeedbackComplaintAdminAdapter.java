...
public class FeedbackComplaintAdminAdapter extends FirebaseRecyclerAdapter<FeedbackComplaintAdminModel, FeedbackComplaintAdminAdapter.myViewHolder> {
     ...
     *
     */
    public FeedbackComplaintAdminAdapter(@NonNull FirebaseRecyclerOptions<FeedbackComplaintAdminModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, int position, @NonNull FeedbackComplaintAdminModel model) {
        ...
        holder.btnDelete.setOnClickListener(view -> {
            ...
            builder.setPositiveButton("Yes", (dialogInterface, i) -> {
                FirebaseDatabase.getInstance().getReference().child("Complaints").child(complaintID).child("FeedBackDescription").setValue("None");
                FirebaseDatabase.getInstance().getReference().child("Complaints").child(complaintID).child("FeedBackStars").setValue(0);
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.feedback_complaint_admin_item,parent,false);
    ...
    static class myViewHolder extends RecyclerView.ViewHolder{
        ...
        public myViewHolder(@NonNull View itemView) {
            ...
            btnDelete = itemView.findViewById(R.id.button_delete1);
        }
    }
}
