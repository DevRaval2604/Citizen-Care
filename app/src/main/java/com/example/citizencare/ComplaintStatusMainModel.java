...
public class ComplaintStatusMainModel {
    ...
    ComplaintStatusMainModel()
    {

    }
    public ComplaintStatusMainModel(String id, String address, String complaintType, String date, String description, String image, String latitude, String longitude, String userID) {
        this.id = id;
        Address = address;
