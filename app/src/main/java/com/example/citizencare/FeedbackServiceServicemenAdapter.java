...
public class FeedbackServiceServicemenAdapter extends FirebaseRecyclerAdapter<FeedbackServiceServicemenModel, FeedbackServiceServicemenAdapter.myViewHolder> {
     ...
     *
     */
    public FeedbackServiceServicemenAdapter(@NonNull FirebaseRecyclerOptions<FeedbackServiceServicemenModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, int position, @NonNull FeedbackServiceServicemenModel model) {
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.feedback_service_servicemen_item,parent,false);
