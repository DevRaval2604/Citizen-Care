...
public class ServicemanAdapter extends FirebaseRecyclerAdapter<MainModel,ServicemanAdapter.myViewHolder> {
     ...
     *
     */
    public ServicemanAdapter(@NonNull FirebaseRecyclerOptions<MainModel> options,String complaintID) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, int position, @NonNull MainModel model) {
        ...
        holder.btnSelect.setOnClickListener(view -> {
            ...
            builder.setPositiveButton("Select", (dialogInterface, i) -> {
                FirebaseDatabase.getInstance().getReference().child("Complaints").child(complaintID).child("ServiceManID").setValue(ServicemanID);
                FirebaseDatabase.getInstance().getReference().child("Complaints").child(complaintID).child("Status").setValue("In-Progress");
                Intent intent=new Intent(holder.fname.getContext(), ManageComplaints.class);
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.select_serviceman,parent,false);
    ...
    static class myViewHolder extends RecyclerView.ViewHolder{
        ...
        public myViewHolder(@NonNull View itemView) {
            ...
            btnSelect= itemView.findViewById(R.id.button_select_serviceman);
        }
    }
}
