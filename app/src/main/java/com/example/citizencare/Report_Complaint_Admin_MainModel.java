...
public class Report_Complaint_Admin_MainModel {
    ...
    Report_Complaint_Admin_MainModel()
    {

    }
    public Report_Complaint_Admin_MainModel(String id, String address, String complaintType, String date, String description, String image, String latitude, String longitude, String userID) {
        this.id = id;
        Address = address;
