...
public class Serviceman_Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_serviceman_register);
        ...
        buttonRegister.setOnClickListener(view -> {
            ...
            if (TextUtils.isEmpty(textFirstName)) {
                Toast.makeText(Serviceman_Register.this, "Please enter your first name", Toast.LENGTH_LONG).show();
                editTextRegisterFirstName.setError("First Name is required");
                editTextRegisterFirstName.requestFocus();
            } else if (!fnameMatcher.find()) {
                Toast.makeText(Serviceman_Register.this, "Please enter only characters", Toast.LENGTH_LONG).show();
                editTextRegisterFirstName.setError("First Name is not valid");
                editTextRegisterFirstName.requestFocus();
            }
            else if (TextUtils.isEmpty(textMiddleName)) {
                Toast.makeText(Serviceman_Register.this, "Please enter your middle name", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(Serviceman_Register.this, "Please enter your last name", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(Serviceman_Register.this, "Please enter your email", Toast.LENGTH_LONG).show();
                editTextRegisterEmail.setError("Email is required");
                editTextRegisterEmail.requestFocus();
            } else if (!Patterns.EMAIL_ADDRESS.matcher(textEmail).matches()) {
                Toast.makeText(Serviceman_Register.this, "Please re-enter your email", Toast.LENGTH_LONG).show();
                editTextRegisterEmail.setError("Valid email is required");
                editTextRegisterEmail.requestFocus();
            } else if (radioGroupRegisterGender.getCheckedRadioButtonId() == -1) {
                Toast.makeText(Serviceman_Register.this, "Please select your gender", Toast.LENGTH_LONG).show();
                radioButtonRegisterGenderSelected.setError("Gender is required");
                radioButtonRegisterGenderSelected.requestFocus();
            } else if (TextUtils.isEmpty(textMobile)) {
                Toast.makeText(Serviceman_Register.this, "Please enter your mobile number", Toast.LENGTH_LONG).show();
                editTextRegisterMobile.setError("Mobile Number is required");
                editTextRegisterMobile.requestFocus();
            } else if (textMobile.length() != 10) {
                Toast.makeText(Serviceman_Register.this, "Please re-enter your mobile number", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(Serviceman_Register.this, "Please enter your password", Toast.LENGTH_LONG).show();
                editTextRegisterPwd.setError("Password is required");
                editTextRegisterPwd.requestFocus();
            } else if (textPwd.length() < 6) {
                Toast.makeText(Serviceman_Register.this, "Password should be at least 6 characters", Toast.LENGTH_LONG).show();
                editTextRegisterPwd.setError("Password too weak");
                editTextRegisterPwd.requestFocus();
            } else if (!passwordMatcher.find()) {
                Toast.makeText(Serviceman_Register.this, "Password must contain atleast one special character,a number and a capital letter", Toast.LENGTH_LONG).show();
                editTextRegisterPwd.setError("Password too weak");
                editTextRegisterPwd.requestFocus();
            } else if (TextUtils.isEmpty(textConfirmPwd)) {
                Toast.makeText(Serviceman_Register.this, "Please confirm your password", Toast.LENGTH_LONG).show();
                editTextRegisterConfirmPwd.setError("Password Confirmation is required");
                editTextRegisterConfirmPwd.requestFocus();
            } else if (!textPwd.equals(textConfirmPwd)) {
                Toast.makeText(Serviceman_Register.this, "Please enter same password", Toast.LENGTH_LONG).show();
                editTextRegisterConfirmPwd.setError("Password Confirmation is required");
                editTextRegisterConfirmPwd.requestFocus();
    ...
    private void registerUser(String textFirstName, String textMiddleName, String textLastName, String textEmail, String textGender, String textMobile, String textPwd) {
        ...
        auth.createUserWithEmailAndPassword(textEmail, textPwd).addOnCompleteListener(Serviceman_Register.this, task -> {
            if (task.isSuccessful()) {
                FirebaseUser firebaseUser =auth.getCurrentUser();
                //Enter User Data into Firebase Realtime Database.
                ReadWriteCitizenDetails WriteCitizenDetails=new ReadWriteCitizenDetails(textFirstName,textMiddleName,textLastName,textEmail,textGender,textMobile,"Serviceman",false);
                ...
                try {
                    ...
                    Toast.makeText(Serviceman_Register.this, e.getMessage(), Toast.LENGTH_LONG).show();
                }
                //Hide ProgressBar whether User creation is successful or failed
                progressBar.setVisibility(View.GONE);
            }
