...
public class ManageServiceType extends DrawerBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delete.setOnClickListener(view -> {
            progressBar.setVisibility(View.VISIBLE);
            if (key!=null){
                AlertDialog.Builder alertDialog=new AlertDialog.Builder(ManageServiceType.this);
                alertDialog.setTitle("Are you sure?");
                alertDialog.setMessage("Deleted service type can't be undo.");
                ...
                alertDialog.setNegativeButton("Cancel",((dialogInterface, i) -> {
                    autoCompleteTextView.setText("");
                    Toast.makeText(ManageServiceType.this, "Cancelled", Toast.LENGTH_LONG).show();
                    progressBar.setVisibility(View.GONE);
                }));
                alertDialog.create();
                alertDialog.show();
