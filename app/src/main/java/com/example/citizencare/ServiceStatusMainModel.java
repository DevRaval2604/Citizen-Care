...
public class ServiceStatusMainModel {
    ...
    ServiceStatusMainModel()
    {

    }
    public ServiceStatusMainModel(String id, String address, String serviceType, String date, String description, String userID) {
        this.id = id;
        Address = address;
